...
if ~exist(generatedDataDir, 'dir')
    mkdir(generatedDataDir);
end

save(fullfile(generatedDataDir, "ABmatrice.mat"), "A", "B")


%% Print in TXT file

fid = fopen(fullfile(generatedDataDir, 'Matrix_centrer.txt'), 'wt' );
% A matrix
for i = 1:12
    for j = 1:12
